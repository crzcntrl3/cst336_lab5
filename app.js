...
app.get("/", async function(req, res){
    let apiUrl = `https://api.unsplash.com/photos/random/?client_id=Mw2ma11kxnxQE9Qt_OJRumwtYOAaJZNiiw11vMXRj_8&featured=true&orientation=landscape`;
...
app.get("/search", async function(req,res){
    ...
    let apiUrl = `https://api.unsplash.com/photos/random/?count=9&client_id=Mw2ma11kxnxQE9Qt_OJRumwtYOAaJZNiiw11vMXRj_8&featured=true&orientation=landscape&query=${keyword}`;
    let response = await fetch(apiUrl);
    let data = await response.json();
